<template>
  <div class="login-page">
    <div class="form">
      <h1 class="header">Register to continue</h1>
      <form @submit.prevent="register" class="login-form">
        ...
        />
        <span v-if="isPasswordTooShort" class="error-message"
          >Password must be 8 characters or longer</span
        >
...
const isPasswordTooShort = computed(() => password.value.length < 8)
